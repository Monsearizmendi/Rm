          ...
          <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item active">
                <a class="nav-link" href="blog/{id}">Blog Entries</a>
              </li>
            </ul>
          </div>
        </div>
                          ...
                          @if($loop->index < 3)
                            <li><a href="post-details.html">
                              <a href="{{route('detalle.personaje',$personajeAlternativo['id'])}}" class="image fit"><img src="{{$personajeAlternativo['imagen']}}" alt="" /></a>
                                <h5>{{$personajeAlternativo['nombre']}}</h5>
          ...
          <div class="container-fluid">
            <div class="owl-banner owl-carousel">
              @foreach ($personajes as $personajeAlterna)
                @if($loop->index >= 17)
                  <div class="item">
                  <a target="_blank" href="{{route('detalle.personaje',$personajeAlterna['id'])}}" class="image featured"><img src="{{$personajeAlterna['imagen']}}" alt="" /></a>
                    <div class="item-content">
                      <div class="main-content">
                        <div class="meta-category">
                          <span></span>
                        </div>
                        <a target="_blank" href="{{route('detalle.personaje',$personajeAlterna['id'])}}">{{$personajeAlterna['nombre']}}</a>
                        <ul class="post-info">
                          <li><a href="#">Especie: {{$personajeAlterna['especie']}}.</a></li>
                          <li><a href="#">Genero: {{$personajeAlterna['genero']}}.</a></li>
                          <li><a href="#">Estatus: {{$personajeAlterna['estatus']}}.</a></li>
                        </ul>
                      </div>
                    </div>
                  </div>
